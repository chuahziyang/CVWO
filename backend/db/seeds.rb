...
Post.create(name:"Ice Cream", category:"Events", status:"online", description:"This is a test post", created_at: DateTime.now, environment:"Active",user:user1, content:"There will now be a minimum karma and account age to post. Too much shitposting and weird spammers.
...
Post.create(name:"Pizza", category:"Technology", status:"offline", description:"This is a test post", created_at: DateTime.now, environment:"Active",user:user1, content:"Been thinking this a long time, but now that I should make a decision whether to take it up, its getting frustrating.
